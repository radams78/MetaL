...
%<*Taxonomy>
\begin{code}%
\>\AgdaKeyword{data} \AgdaDatatype{stlcVariableKind} \AgdaSymbol{:} \AgdaPrimitiveType{Set} \AgdaKeyword{where}\<%
\\
\>[0]\AgdaIndent{2}{}\<[2]%
\>[2]\AgdaInductiveConstructor{-term} \AgdaSymbol{:} \AgdaDatatype{stlcVariableKind}\<%
\\
%
\\
\>\AgdaKeyword{data} \AgdaDatatype{stlcNonVariableKind} \AgdaSymbol{:} \AgdaPrimitiveType{Set} \AgdaKeyword{where}\<%
\\
\>[0]\AgdaIndent{2}{}\<[2]%
\>[2]\AgdaInductiveConstructor{-type} \AgdaSymbol{:} \AgdaDatatype{stlcNonVariableKind}\<%
\\
%
\\
...
\\
\>[0]\AgdaIndent{2}{}\<[2]%
\>[2]\AgdaField{VariableKind} \AgdaSymbol{=} \AgdaDatatype{stlcVariableKind} \AgdaSymbol{;} \<[36]%
\>[36]\<%
\\
\>[0]\AgdaIndent{2}{}\<[2]%
\>[2]\AgdaField{NonVariableKind} \AgdaSymbol{=} \AgdaDatatype{stlcNonVariableKind} \AgdaSymbol{\}}\<%
\end{code}
%</Taxonomy>
...
\begin{code}%
\>[0]\AgdaIndent{2}{}\<[2]%
\>[2]\AgdaFunction{type} \AgdaSymbol{:} \AgdaDatatype{ExpressionKind}\<%
\\
\>[0]\AgdaIndent{2}{}\<[2]%
\>[2]\AgdaFunction{type} \AgdaSymbol{=} \AgdaInductiveConstructor{nonVariableKind} \AgdaInductiveConstructor{-type}\<%
\\
%
\\
\>[0]\AgdaIndent{2}{}\<[2]%
\>[2]\AgdaFunction{term} \AgdaSymbol{:} \AgdaDatatype{ExpressionKind}\<%
\\
\>[0]\AgdaIndent{2}{}\<[2]%
...
\\
\>[0]\AgdaIndent{2}{}\<[2]%
\>[2]\AgdaKeyword{data} \AgdaDatatype{stlcCon} \AgdaSymbol{:} \AgdaFunction{ConstructorKind} \AgdaSymbol{→} \AgdaPrimitiveType{Set} \AgdaKeyword{where}\<%
\\
\>[2]\AgdaIndent{4}{}\<[4]%
...
\begin{code}%
\>[0]\AgdaIndent{2}{}\<[2]%
\>[2]\AgdaFunction{stlcParent} \AgdaSymbol{:} \AgdaFunction{VariableKind} \AgdaSymbol{→} \AgdaDatatype{ExpressionKind}\<%
\\
\>[0]\AgdaIndent{2}{}\<[2]%
...
\AgdaHide{
\begin{code}%
\>\AgdaKeyword{open} \AgdaModule{STLCGrammar} \AgdaKeyword{public}\<%
\\
\>\AgdaKeyword{open} \AgdaModule{Grammar} \AgdaFunction{STLCGrammar.stlc} \AgdaKeyword{public}\<%
\end{code}
}
